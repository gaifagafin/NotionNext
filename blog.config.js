...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'GaifaGafin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '将躺平当成事业', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://gaifagafin.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '笔记, 博客', // 网站关键词 英文逗号隔开
